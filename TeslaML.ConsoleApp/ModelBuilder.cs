...
namespace TeslaML.ConsoleApp
{
    ...
    {
        private static string TRAIN_DATA_FILEPATH = @"C:\Users\Jahangir\AppData\Local\Temp\e0f7603e-98b7-46ff-8a0d-8b2e12798e4b.tsv";
        private static string MODEL_FILEPATH = @"../../../../TeslaML.Model/MLModel.zip";
        ...
        public static IEstimator<ITransformer> BuildTrainingPipeline(MLContext mlContext)
        {
            ...
            var dataProcessPipeline = mlContext.Transforms.Text.FeaturizeText("Id_tf", "Id")
                                      .Append(mlContext.Transforms.Text.FeaturizeText("SentimentText_tf", "SentimentText"))
                                      .Append(mlContext.Transforms.Concatenate("Features", new[] { "Id_tf", "SentimentText_tf" }));

            // Set the training algorithm 
            var trainer = mlContext.BinaryClassification.Trainers.FastTree(labelColumnName: "Sentiment", featureColumnName: "Features");
